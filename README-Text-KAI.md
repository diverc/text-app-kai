...
* ダウンロードと展開
  - [こちらよりcrxファイル](https://github.com/diverc/text-app-kai/releases/download/KAI-R1/Text-KAI-0.7.15.crx) をダウンロードする。
  
* chromeで開発者モードでインストール
  - chrome://extensions/ にアクセス
  - デベロッパーモードをオン
  - crxファイルをドラッグし、インストールする。
...
* ダウンロードと展開
  - [こちらよりzipファイル](https://github.com/diverc/text-app-kai/releases/download/KAI-R1/Text-KAI-0.7.15.zip) をダウンロードして、展開する。
